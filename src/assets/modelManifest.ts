...
const JACARANDA_MODELS: readonly TreeModelDefinition[] = [
  {
    ...
    worldScale: 0.07,
    minimumSpacing: 2.05,
    intendedUse: 'Eight deterministic wide-canopy foreground trees for the Web 1K demo.',
  },
  {
    ...
    worldScale: 0.07,
    minimumSpacing: 2.05,
    intendedUse: 'Ten deterministic wide-canopy foreground trees for the Desktop 2K pack.',
  },
  {
    ...
    worldScale: 0.07,
    minimumSpacing: 2.05,
    intendedUse: 'Ten deterministic wide-canopy foreground trees for the Desktop 4K Ultra pack.',
  },
]
